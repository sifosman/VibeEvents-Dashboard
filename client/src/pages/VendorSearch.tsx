...
export default function VendorSearch({ categoryId }: VendorSearchProps) {
  ...
  return (
    <>
      <Helmet>
        <title>{category?.name ? `${category.name} Search` : 'Vendor Search'} | HowzEventz</title>
        <meta name="description" content={`Find ${category?.name?.toLowerCase() || 'vendors'} for your event`} />
      </Helmet>
      ...
      <div className="container-custom py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Find the perfect vendor for your event</p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4">
            {vendors ? `${vendors.length} vendors found` : 'Searching vendors...'}
          </h2>
